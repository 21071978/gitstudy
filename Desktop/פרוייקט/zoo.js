...
function findKey2(arr, keyToFind, start, end) {
  console.log(arr, keyToFind, start, end,Number(arr[6].key))
 // if (Number(keyToFind) > Number(arr[end / 2].key))
    findKey2(arr, keyToFind, end/2, end);
  if (Number(keyToFind) < Number(arr[end / 2].key))
    findKey2(arr, keyToFind, start, (end / 2).round);
 // if (Number(keyToFind) === Number(arr[end / 2].key)) return 1;
